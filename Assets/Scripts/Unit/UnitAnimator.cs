...
public class UnitAnimator : MonoBehaviour
{
    ...
    Animator leftHeldItemAnim, rightHeldItemAnim;
    ...
    public Animator GetLeftHandItemAnim()
    {
        return leftHeldItemAnim;
    }

    public Animator GetRightHandItemAnim()
    {
        return rightHeldItemAnim;
    }
